...
export default function ContactPage() {
  ...
  return (
    <div className="container-px py-16">
      ...
      <div className="mb-10"><PageHero title="Contact" subtitle="Tell us what you’re building — we’ll respond with next steps and a delivery plan." /></div>
<div className="max-w-3xl">
        <h1 className="h1">Let’s Build Something Great Together</h1>
        <p className="mt-3 muted">
          Tell us about your project. We’ll respond with next steps and a delivery plan.
        </p>
      </div>
